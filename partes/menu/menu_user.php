...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-lg  bg-body rounded">
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><img src="img/recursos/logo.png" width="200" height="100" class="img-thumbnail" alt="..."></a>
          ...
          <button type="button" class="btn btn-danger btnOcul">Perfil</button>
        </div>
      </nav>
<!-- final menu -->