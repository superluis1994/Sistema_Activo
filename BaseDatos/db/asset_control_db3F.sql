...
insert  into `account_status`(`id_account_status`,`status`) values (45,'recargar');
...
insert  into `local`(`id_local`,`local_name`,`jefe_local`) values ('St-14','Biblioteca',130121);
insert  into `local`(`id_local`,`local_name`,`jefe_local`) values ('St-15','Computo',NULL);
